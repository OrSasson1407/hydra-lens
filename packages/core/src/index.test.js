...
describe("detectMismatches (integration)", () => {
    ...
    it("sync and async detectors return the same results in the same order", async () => {
        ...
        const serverHTML = '<html><body><p>Server A</p><p>Server B</p><div class="x" data-val="s"></div></body></html>';
        const clientDoc = makeClientDoc('<head></head><body><p>Client A</p><p>Client B</p><div class="x" data-val="c"></div></body>');
